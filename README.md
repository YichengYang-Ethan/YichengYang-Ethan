...
| [`coinjure`](https://github.com/ulab-uiuc/prediction-market-cli) | Agent-native prediction market CLI (UIUC ulab) — discover, backtest & deploy | Cross-platform relation discovery (8 types) · ~50 parallel strategies · Kelly allocation · [PyPI](https://pypi.org/project/coinjure/) |
...
| [`clawdfolio`](https://github.com/YichengYang-Ethan/clawdfolio) | Portfolio analytics toolkit — multi-broker aggregation, risk & options | Fama-French 3-factor · GARCH · covered call strategy (83% win rate, +3.0% α) · [PyPI](https://pypi.org/project/clawdfolio/) |
